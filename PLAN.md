...
> ⚠️ **Статусы шагов внутри устарели** (велись до мая 2026). Актуальное состояние проекта —
> в [ARCHITECTURE.md](ARCHITECTURE.md) и [README.md](README.md). Лог `progress.txt` упразднён
> (история — в git). Ценность этого файла — **роадмап будущих шагов** (локальная проверка,
> YouGile/Keitaro, адаптация, упаковка, E2E).
>
